...
/*
double classify(const unsigned char myImage[50][50][3]) {
    unsigned char myImageVector[7500];
    int contador = 0;
    for (int i = 0; i < 50; i++) {
        for (int j = 0; j < 50; j++) {
            myImageVector[contador] = myImage[j][i][2];
            contador++;
        }
    }
    for (int i = 0; i < 50; i++) {
        for (int j = 0; j < 50; j++) {
            myImageVector[contador] = myImage[j][i][1];
            contador++;
        }
    }
    for (int i = 0; i < 50; i++) {
        for (int j = 0; j < 50; j++) {
            myImageVector[contador] = myImage[j][i][0];
            contador++;
        }
    }
